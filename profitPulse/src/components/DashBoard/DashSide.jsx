    ...
    <div>
      <header>
        <div className="logo-wrapper">
          <img src="https://icons.veryicon.com/png/o/internet--web/prejudice/user-128.png" alt="Logo" className="logo" />
          <h3>Dashboard</h3>
        </div>
        <nav>
        <Link to="/">Home</Link>
      ...
      <div className="dash-container">
        {/* Left sidebar */}
        <div className={`sidebar left-sidebar ${leftSidebarMinimized ? "minimized" : ""}`}>
        ...
        <div className={`content ${leftSidebarMinimized ? "minimized-left" : ""} ${rightSidebarMinimized ? "minimized-right" : ""}`}>
        ...
        {/* Right sidebar */}
        <div className={`sidebar right-sidebar ${rightSidebarMinimized ? "minimized" : ""}`}>
